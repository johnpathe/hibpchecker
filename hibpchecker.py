...
[u'PwnCount', u'Domain', u'IsSensitive', u'Name', u'Title', u'DataClasses', u'IsRetired', u'IsSpamList', u'BreachDate', u'IsFabricated', 
#u'ModifiedDate', u'LogoPath', u'AddedDate', u'IsVerified', u'Description']
...
def pwnedChecker(account):
	...
	if isinstance(result,str):
		print 'Email address not involved in any breaches on haveibeenpwned.com'
	if isinstance(result,list):
		...
		for breach in result:
			...
			print 'Data Classes:'
			for classType in breach['DataClasses']:
				print '  %s' % classType
	print '\n'
